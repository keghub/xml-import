...
Currently, you can specify whom we should forward a lead to for the courses by providing up to 5 email addresses, and specify a link to your external information request form.
